...
class MC24LC08: public EepromDriver<MC24LC08, I2CDevice, I2C_HandleTypeDef> {
public:
    /**
     * Constructor.
     ...
     */
  MC24LC08(I2C_HandleTypeDef* ifc);
...
protected:
    ...
    friend EepromDriver<MC24LC08, I2CDevice, I2C_HandleTypeDef>;      ///< own base class has access to protected methods
private:
    /**
