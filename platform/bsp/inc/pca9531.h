...
public:
     ...
     *  @param[in] reset port.
     *  @param[in] reset pin. must be high in normal operation
     */
    PCA9531(PortPin rs,
    		I2C_HandleTypeDef* intf,
			uint8_t addr = PCA9531_BaseAddress);
    ...
    void enable() { m_reset.set(); }
    void disable() { m_reset.clear(); }


    static const uint8_t PCA9531_BaseAddress = 0x60;
