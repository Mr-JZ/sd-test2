 ...
 *  e.g:\n
 *  \code
 *  class MC24LC64 : public EepromDriver<MC24LC64, I2CDevice, I2C_HandleTypeDef>
 *  {
 *  protected:
 ...
 *     friend EepromDriver<MC24LC64, I2CDevice, I2C_HandleTypeDef>;
 *  };
 *  \endcode
 *
 *  \tparam T Class of specific EEPROM driver
 *  \tparam U Class of HW Interface, e.g I2CDevice or SSPDevice
 *  \tparam V handler of U, e.g. I2C_HandleTypeDef or SPI_HandleTypeDef
