...
C_SRCS += \
../Drivers/Application/loopback/loopback.c 

C_DEPS += \
./Drivers/Application/loopback/loopback.d 

OBJS += \
./Drivers/Application/loopback/loopback.o 


# Each subdirectory must supply rules for building sources it contributes
Drivers/Application/loopback/%.o Drivers/Application/loopback/%.su Drivers/Application/loopback/%.cyclo: ../Drivers/Application/loopback/%.c Drivers/Application/loopback/subdir.mk
...
clean: clean-Drivers-2f-Application-2f-loopback

clean-Drivers-2f-Application-2f-loopback:
	-$(RM) ./Drivers/Application/loopback/loopback.cyclo ./Drivers/Application/loopback/loopback.d ./Drivers/Application/loopback/loopback.o ./Drivers/Application/loopback/loopback.su

.PHONY: clean-Drivers-2f-Application-2f-loopback
